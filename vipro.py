...
vipro = LINETCR.LINE()
#vipro.login(qr=True)
vipro.login(token='Eq92DukaZRHFrKXiJEMe.GG0bjs+C8Qu5/HLlZ8nadG.sKDL0q93Fim+blt3U5sIGUI4h90BOwWFyVp823DtN8E=')
vipro.loginResult()
print "🐯हईທຮຮๅજईह🐯-Login Success\n\n=====[🐯हईທຮຮๅજईह🐯 Login]====="
...
Bots=[mid]
Creator=["u820d01252fdcf2a539fa194bcfc3400e"]
admin=["u820d01252fdcf2a539fa194bcfc3400e"]
        ...
        if op.type == 25:
          if wait["Bot"] == True:    
			...
			vipro.sendText(msg.to,"Admin Detected~")
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        if ginfo.preventJoinByTicket == True:
                            ...
                            u = "เปิด"
                        vipro.sendText(msg.to,"[ชื่อกลุ่ม]\n" + str(ginfo.name) + "\n\n[ไอดีกลุ่ม]\n" + msg.to + "\n\n[ผู้สร้างกลุ่ม]\n" + gCreator + "\n\n[รูปภาพกลุ่ม]\nhttp://dl.profile.line.naver.jp/" + ginfo.pictureStatus + "\n\nสมาชิกกลุ่ม:" + str(len(ginfo.members)) + "คน\nสมาชิกค้างเชิญ:" + sinvitee + "คน\nลิ้งค์กลุ่ม:" + u + "อยู่")
                    else:
                        vipro.sendText(msg.to,"[ชื่อกลุ่ม]\n" + str(ginfo.name) + "\n[ไอดีกลุ่ม]\n" + msg.to + "\n[ผู้สร้างกลุ่ม]\n" + gCreator + "\n[รูปภาพกลุ่ม]\nhttp://dl.profile.line.naver.jp/" + ginfo.pictureStatus)
                else:
                    if wait["lang"] == "JP":
                ...
                vipro.sendMessage(msg)
		vipro.sendText(msg.to,"ผู้สร้างบอท")
